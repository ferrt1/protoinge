...
export const NavBar = () => {
  ...
  return (
    <>
    <ul className={`fixed bg-white w-[100%] h-full font-bold flex-1 flex flex-col items-center justify-center gap-10 ${showMenu ? "left-0" : "-left-full z-50"}
        ...
        <li><a href="/map">Centros de atención</a></li>
